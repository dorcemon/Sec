...
public class InvokerTransformerStudy {
    ...
    public void testNative() throws IOException, ClassNotFoundException {
        ...
        ObjectInputStream objectInputStream = new ObjectInputStream(new ByteArrayInputStream(code));
